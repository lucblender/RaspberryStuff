...
try:
    ...
    #HBlackimage = Image.new('1', (200, 200), 255)  # 600*448
    #HRedimage = Image.new('1', (200, 200), 255)  # 600*448 
    
    # Horizontal
    print("Drawing")
    drawblack = ImageDraw.Draw(HBlackimage)
    drawred = ImageDraw.Draw(HRedimage)
    albumOutBlack = Image.open('albumOutBlack.bmp')
    albumOutRed = Image.open('albumOutRed.bmp')    
    ...
    drawblack.text((375, 110), titre, font = font25Regular, fill = 0)
