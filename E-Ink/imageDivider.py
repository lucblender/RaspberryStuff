...
#
# @brief 
# @param[in] inputFile : input file path OR input file url
# @param[in] outputRedFile : output path of black/with picture black channel 
# @param[in] outputBlackFile : output path of black/with picture black channel 
# @param[in] inputFileResized : output path of resized picture
# @param[in] desiredSize : Int, longest size of the output pictures
# @return void
# 
#******************************************************************************
def divideFromSource(inputFile = "album.jpg", outputRedFile = "albumOutRed.bmp", outputBlackFile = "albumOutBlack.bmp", inputFileResized = "inputFileResized.bmp", desiredSize = 350):
